    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-black leading-tight text-slate-950">Instala COPILOT en tu celular</p>
          <p className="mt-1 text-xs leading-5 text-slate-500">
            {deferredPrompt ? "Accede mas rapido desde la pantalla de inicio." : "Abre el menu de Chrome y toca Instalar app."}
          </p>
        </div>
